<div class="modal-dialog" id="handlerProjectModalDialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="">
                <span aria-hidden="true">&times;</span>
            </button>
            <h4 class="modal-title" id="handlerProModalLabel"></h4>
        </div>
        <div class="modal-body">
            <div class="form-group">
                <label for="txt_departmentname">项目名称</label>
                <textarea id="txt_handlerProject_departmentname" name="content" rows="3" cols="5" placeholder=""></textarea>
            </div>
        </div>
